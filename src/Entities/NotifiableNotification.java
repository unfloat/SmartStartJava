...
public class NotifiableNotification  {
    ...
    private NotifiableEntity notifiableEntityId;
    ...
    public NotifiableEntity getNotifiableEntityId() {
        return notifiableEntityId;
    }

    public void setNotifiableEntityId(NotifiableEntity notifiableEntityId) {
    ...
    public String toString() {
        return "Entities.NotifiableNotification[ id=" + id + " ]";
    }
